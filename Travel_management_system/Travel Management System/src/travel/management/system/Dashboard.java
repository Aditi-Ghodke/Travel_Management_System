...
public class Dashboard extends JFrame implements ActionListener{
    ...
    JButton addPersonalDetails, viewPersonalDetails,updatePersonalDetails,checkpackages, bookpackages, viewpackages, viewhotels, destinations, bookhotels, viewBookedHotel, payments, calculators, notepad, about,deletePersonalDetails, logout;
    String username;
    Dashboard(String username) {
        
        this.username = username;
        
//       setBounds(0,0,1600,1000);//laptop size or setEXtendedState
        ...
        logout.setBounds(1380,20,130,30);
