...
public class CheckHotels extends JFrame implements Runnable{
    ...
    @Override
    public void run() {
        String[] text = new String[] {"JW Mariott Hotel", "Mdarin Oriental Hotel", "Four Seasons Hotel", "Raddison Blue", "Classico Hotel", "Bay Club Hotel", "Breeze Blow Hotel", "The Taj Hotel", "Happy Morning Hotel", "River View Hotel" };
        try {
            for(int i =0; i<=9; i++) {
